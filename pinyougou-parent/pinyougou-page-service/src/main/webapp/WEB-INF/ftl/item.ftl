...
<!--页面顶部 结束-->
			...
			<div class="product-info">
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						<!--默认第一个预览-->
						<!--item_images:
							[{"color":"白色","url":"http://192.168.25.133//group1/M00/00/00/wKgZhVwaO76AVLBXAADjyJcvras223.jpg"},
							{"color":"蓝色","url":"192.168.25.133/group1/M00/00/01/wKgZhVwlvtmAc4C1AAAgRqSstX4455.png"},
							{"color":"黑色","url":"http://192.168.25.133/group1/M00/00/01/wKgZhVwlvueAC1rIAAAkGaLTot8010.png"}]-->
						<!-- 判断是否有图片 -->
						...
						<div class="spec-scroll">
							...
							<div class="items">
								...
								<ul>
								<#list imageList as pojo>
									<li><img src="${pojo.url}" bimg="${pojo.url}" onmousemove="preview(this)" /></li>
								</#list>
								</ul>
				...
				<div class="fr itemInfo-wrap">
					...
					<div class="support">
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								<em class="t-gray">${goodsDesc.packageList}</em>
							</div>
						</div>
						<div class="summary-wrap">
							<div class="fl title">
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<!-- 点击将参数传入js中定义的变量 :'${spec.attributeName}'加上引号,变为字符串-->
								<dd>
							...
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										...
										<input autocomplete="off" type="text" ng-model="num" class="itxt" /> 
    ...
    <input type="checkbox"><span>99</span>
					...
					<!-- 扩展属性: #assign customAttributeList=goodsDesc.itemAttributeItems #assign specificationList=goodsDesc.specificationItems  -->
